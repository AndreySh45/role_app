    ...
    <div class="flex flex-col h-full bg-blue-600">
        ...
        <div class="flex-1 overflow-x-auto">
          <div class="inline-flex h-full items-start px-4 pb-4 space-x-4">
            <div v-for="item in Array.from({length:9})" class="w-72 bg-gray-200 max-h-full flex flex-col rounded-md">
              ...
              <div class="pb-3 flex flex-col overflow-hidden">
                <div class="px-3 flex-1 overflow-y-auto">
                  <ul class="space-y-3">
                    <li v-for="item in Array.from({length: 10})" class="group relative bg-white p-3 shadow rounded-md border-b border-gray-300 hover:bg-gray-50">
